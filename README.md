...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/r-clickr-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11478&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-clickr-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-clickr` can be installed with:

```
conda install r-clickr
```

It is possible to list all of the versions of `r-clickr` available on your platform with:
